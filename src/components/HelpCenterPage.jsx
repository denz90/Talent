    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 pb-20">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <div className="relative max-w-2xl mx-auto">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-4 rounded-xl border-none outline-none focus:ring-2 focus:ring-brand-primary bg-white text-lg shadow-lg"
            />
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 -mt-10 relative z-20">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100 flex flex-col md:flex-row gap-12">
          <div className="md:w-1/2">
            ...
            <ul className="space-y-4">
              {popularArticles.map((article, idx) => (
                <li key={idx}>
                  <a href="#" className="text-slate-600 hover:text-brand-primary font-medium flex items-center group">
          ...
          <div className="md:w-1/2 bg-slate-50 rounded-2xl p-8 text-center flex flex-col justify-center items-center">
