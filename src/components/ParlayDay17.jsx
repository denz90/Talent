      ...
      <div className="max-w-4xl mx-auto px-8 py-10 space-y-12 pb-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                  <div className="bg-site-bg p-8 rounded-2xl border border-site-primary flex flex-col gap-4 group hover:bg-site-bg transition-colors">
                    ...
                    <p className="text-site-text font-medium">
                      <span className="font-bold text-site-primary block mb-1">Boosts Engagement:</span>
                  ...
                  <div className="bg-site-bg p-8 rounded-2xl border border-site-primary flex flex-col gap-4 group hover:bg-site-bg transition-colors">
                    ...
                    <p className="text-site-text font-medium">
                      <span className="font-bold text-site-primary block mb-1">Assessment Made Easy:</span>
                  ...
                  <div className="bg-site-bg p-8 rounded-2xl border border-site-primary flex flex-col gap-4 group hover:bg-site-bg transition-colors">
                    ...
                    <p className="text-site-text font-medium">
                      <span className="font-bold text-site-primary block mb-1">Inclusive Dialogues:</span>
                  ...
                  <div className="bg-site-bg p-8 rounded-2xl border border-site-primary flex flex-col gap-4 group hover:bg-site-bg transition-colors">
                    ...
                    <p className="text-site-text font-medium">
                      <span className="font-bold text-site-primary block mb-1">AI Feedback:</span>
          ...
          {activeTab === 'features' && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="text-sm">
                        ...
                        <p className="text-site-text">Create live/async discussions with prompts, rubrics, and peer feedback.</p>
                      </div>
                ...
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6 group hover:border-blue-500/30 transition-all">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">Students type responses instead of speaking (supports shy learners).</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
                ...
                {/* Feature 3 */}
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6 group hover:border-green-500/30 transition-all">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">Parlay analyzes discussions → generates insights (e.g., "75% cited evidence").</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
                ...
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6 group hover:border-orange-500/30 transition-all">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">Attach grading criteria (e.g., "Claims supported by evidence → 20pts").</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
            ...
            <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="bg-yellow-400/10 border border-yellow-400/20 rounded-3xl p-10 relative overflow-hidden group">
                ...
                <div className="flex items-center gap-4 mb-6 relative z-10">
                  ...
                  <div>
                    ...
                    <p className="text-site-text/70">"Host a RoundTable on digital ethics and analyze student engagement."</p>
                  </div>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent space-y-6 relative group overflow-hidden">
              ...
              <div className="pt-10 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-site-bg p-8 rounded-3xl border border-site-accent group hover:border-orange-500/50 transition-all">
                    <div className="w-10 h-10 rounded-xl bg-site-primary/40 flex items-center justify-center text-site-text mb-4">
                      <Award size={20} />
                    </div>
                    <p className="text-sm leading-relaxed text-site-text">
        ...
        <div className="relative rounded-[40px] overflow-hidden bg-gradient-to-r from-site-grad-from to-site-grad-to p-12 text-center space-y-8 shadow-2xl shadow-site-accent-600/20">
          ...
          <div className="space-y-4 relative z-10">
            ...
            <p className="text-site-text font-medium">Share your RoundTable insights with #AIDiscussionChallenge!</p>
          </div>
