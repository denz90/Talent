    ...
    <div className="w-full h-full overflow-y-auto bg-site-primary text-site-text">
      <div className="max-w-4xl mx-auto px-8 py-10 space-y-12 pb-32">
        ...
        <div className="text-center space-y-6 pt-8">
          ...
          <h1 className="text-5xl md:text-6xl font-black tracking-tight">Grok AI Challenge</h1>
        ...
        <div className="min-h-[500px]">
          {activeTab === 'overview' && (
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="bg-site-bg rounded-3xl p-10 border border-site-accent">
                <h2 className="text-3xl font-bold mb-6">What is Grok?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                  ...
                  <div className="bg-site-bg p-8 rounded-2xl border border-site-primary flex flex-col gap-4 group hover:bg-site-bg transition-colors">
                    ...
                    <p className="text-site-text font-medium">
                      <span className="font-bold text-site-primary block mb-1">Active Learning:</span>
                      Transform passive videos into active lessons by embedding questions, polls, and prompts.
                    </p>
                  </div>
                  <div className="bg-site-bg p-8 rounded-2xl border border-site-primary flex flex-col gap-4 group hover:bg-site-bg transition-colors">
                    <div className="w-12 h-12 rounded-xl bg-site-text flex items-center justify-center hover:bg-site-primary transition-colors text-site-accent">
                    ...
                    <p className="text-site-text font-medium">
                      <span className="font-bold text-site-primary block mb-1">Rapid Video Editing:</span>
                      AI suggests improvements, transitions, and interactive overlays to save editing time.
                    </p>
                  </div>
                  <div className="bg-site-bg p-8 rounded-2xl border border-site-primary flex flex-col gap-4 group hover:bg-site-bg transition-colors">
                    <div className="w-12 h-12 rounded-xl bg-site-text flex items-center justify-center hover:bg-site-primary transition-colors text-site-accent">
                    ...
                    <p className="text-site-text font-medium">
                      <span className="font-bold text-site-primary block mb-1">Engagement Tracking:</span>
                      Monitor student progress, quiz performance, and rewatch trends in real-time.
                    </p>
                  </div>
                  <div className="bg-site-bg p-8 rounded-2xl border border-site-primary flex flex-col gap-4 group hover:bg-site-bg transition-colors">
                    <div className="w-12 h-12 rounded-xl bg-site-text flex items-center justify-center hover:bg-site-primary transition-colors text-site-accent">
                    ...
                    <p className="text-site-text font-medium">
                      <span className="font-bold text-site-primary block mb-1">Differentiated Instruction:</span>
                      Supports captions, translations, and audio customization for diverse learners.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Interactive Overlays</h3>
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">Click "Add Quiz" at any timestamp to insert questions or polls</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        ...
                        <p className="text-xs font-bold text-green-100">Turns passive watching into active participation</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">AI Feedback System</h3>
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">Enable real-time feedback for student answers within the video</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
                        <p className="text-xs font-bold text-green-100">Immediate clarification of misconceptions for students</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">View Analytics Dashboard for participation, quiz results, and rewatch trends</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
                        <p className="text-xs font-bold text-green-100">Identify struggling students instantly and guide future instruction</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Custom Narration</h3>
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">Record voiceovers or use AI voices to explain key concepts</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
                        <p className="text-xs font-bold text-green-100">Supports diverse learning styles and multilingual classes through language adjustment</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chaptering &amp; Nav</h3>
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">Auto-generate chapters for long lesson videos</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
                        <p className="text-xs font-bold text-green-100">Allows students to easily revisit specific topics</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Auto-Captions</h3>
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">Generate and edit captions for accessibility in any language</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
                        <p className="text-xs font-bold text-green-100">Ensures all students can follow along effectively</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {[
          {
                    "step": 1,
                    "title": "Sign Up",
                    "content": "Go to GrokAI.com \u2192 Click \"Educator Sign Up\" \u2192 Verify email."
          },
          {
                    "step": 2,
                    "title": "Upload Videos",
                    "content": "Import a video from Lovart AI, YouTube, or your device. Review AI-suggested storyboard improvements."
          },
          {
                    "step": 3,
                    "title": "Add Interactivity",
                    "content": "Click \"Add Quiz\" \u2192 Insert multiple-choice, T/F, or open-ended questions at key timestamps. Add polls or reflection prompts to spark discussion."
          },
          {
                    "step": 4,
                    "title": "Customize Narration",
                    "content": "Record your own voice or let AI generate narration. Adjust pace, tone, or language for ESL or differentiated instruction."
          },
          {
                    "step": 5,
                    "title": "Monitor & Share",
                    "content": "Use the Analytics tab to track student engagement and quiz performance. Export as interactive MP4 or share via LMS link."
          }
].map((step) => (
              ...
              <div className="bg-yellow-400/10 border border-yellow-400/20 rounded-3xl p-10">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-site-text/70">"Enhance a Lovert AI Lesson Video with Interactivity andanalytics using Grok AI."</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl font-bold">Upload Base Video</h3>
                  </div>
                  <p className="text-sm text-site-text">Take your Day 5 Lovart AI video (e.g., "Water Cycle for Grade 5") → Upload to Grok AI. Screenshot AI enhancement suggestions.</p>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl font-bold">Add Interactivity</h3>
                  </div>
                  <p className="text-sm text-site-text">Embed 3–5 quiz questions at critical points in the video. Add 1–2 reflection prompts or polls to encourage participation.</p>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl font-bold">Personalize Narration &amp; Visuals</h3>
                  </div>
                  <p className="text-sm text-site-text">Record voiceover for at least 1 concept explanation. Adjust visuals or transitions to highlight key ideas.</p>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl font-bold">Analyze Engagement</h3>
                  </div>
                  <p className="text-sm text-site-text">Share the video with 2–3 students/colleagues → Screenshot Analytics dashboard. Note insights such as "Most students paused at 2:15 – explain photosynthesis diagram again."</p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-site-bg p-6 rounded-3xl border border-site-accent relative overflow-hidden group hover:border-pink-500/50 transition-all">
                    ...
                    <p className="text-sm leading-relaxed text-site-text">
                      <span className="font-bold text-site-primary block mb-1">Time Quizzes Strategically:</span>
                      Place questions right after complex topics to maximize retention.
                    </p>
                  </div>
                  <div className="bg-site-bg p-6 rounded-3xl border border-site-accent relative overflow-hidden group hover:border-site-primary-500/50 transition-all">
                    ...
                    <p className="text-sm leading-relaxed text-site-text">
                      <span className="font-bold text-site-primary block mb-1">Mix Formats:</span>
                      Alternate multiple-choice with short reflection prompts to maintain attention.
                    </p>
                  </div>
                  <div className="bg-site-bg p-6 rounded-3xl border border-site-accent relative overflow-hidden group hover:border-yellow-500/50 transition-all">
                    ...
                    <p className="text-sm leading-relaxed text-site-text">
                      <span className="font-bold text-site-primary block mb-1">Peer Collaboration:</span>
                      Share enhanced videos with colleagues for co-created lessons.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <p className="text-center text-site-text/60 text-sm pb-10">
          Next Up: Day 7 – Continue your AI education journey
        </p>
