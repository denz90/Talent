    ...
    <div className="w-full h-full overflow-y-auto bg-site-primary text-site-text">
      <div className="max-w-4xl mx-auto px-8 py-10 space-y-12 pb-32">
        ...
        <div className="text-center space-y-6 pt-8">
          ...
          <h1 className="text-5xl md:text-6xl font-black tracking-tight">Quizizz (AI Mode) Challenge</h1>
        ...
        <div className="min-h-[500px]">
          {activeTab === 'overview' && (
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="bg-site-bg rounded-3xl p-10 border border-site-accent">
                <h2 className="text-3xl font-bold mb-6">What is Quizizz (AI Mode)?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                  ...
                  <div className="bg-site-bg p-8 rounded-2xl border border-site-primary flex flex-col gap-4 group hover:bg-site-bg transition-colors">
                    ...
                    <p className="text-site-text font-medium">
                      <span className="font-bold text-site-primary block mb-1">AI Quiz Generation:</span>
                      Generate a full quiz from any topic, URL, or uploaded document in seconds — no manual question writing needed.
                    </p>
                  </div>
                  <div className="bg-site-bg p-8 rounded-2xl border border-site-primary flex flex-col gap-4 group hover:bg-site-bg transition-colors">
                    <div className="w-12 h-12 rounded-xl bg-site-text flex items-center justify-center hover:bg-site-primary transition-colors text-site-accent">
                    ...
                    <p className="text-site-text font-medium">
                      <span className="font-bold text-site-primary block mb-1">Adaptive Learning:</span>
                      AI adjusts question difficulty in real time based on each student's performance, keeping every learner challenged.
                    </p>
                  </div>
                  <div className="bg-site-bg p-8 rounded-2xl border border-site-primary flex flex-col gap-4 group hover:bg-site-bg transition-colors">
                    <div className="w-12 h-12 rounded-xl bg-site-text flex items-center justify-center hover:bg-site-primary transition-colors text-site-accent">
                    ...
                    <p className="text-site-text font-medium">
                      <span className="font-bold text-site-primary block mb-1">Gamified Engagement:</span>
                      Leaderboards, power-ups, and memes keep students motivated and actively participating throughout every quiz.
                    </p>
                  </div>
                  <div className="bg-site-bg p-8 rounded-2xl border border-site-primary flex flex-col gap-4 group hover:bg-site-bg transition-colors">
                    <div className="w-12 h-12 rounded-xl bg-site-text flex items-center justify-center hover:bg-site-primary transition-colors text-site-accent">
                    ...
                    <p className="text-site-text font-medium">
                      <span className="font-bold text-site-primary block mb-1">Instant Data Insights:</span>
                      Post-quiz reports pinpoint exactly which students need reteaching on which specific concepts.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">AI Quiz Builder</h3>
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">Type a topic or paste a document → AI instantly generates a full set of questions with answer choices and explanations</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        ...
                        <p className="text-xs font-bold text-green-100">That final assessment ready in under 2 minutes instead of 30</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Adaptive Mode</h3>
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">Enable "Adaptive" in quiz settings → AI adjusts question difficulty based on each student's live performance</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
                        <p className="text-xs font-bold text-green-100">Differentiates automatically — no extra planning needed</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Live Game Mode</h3>
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">Launch a quiz as a live class game — students join with a code and compete on a real-time leaderboard</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
                        <p className="text-xs font-bold text-green-100">Dramatically boosts engagement and participation rates</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Homework Mode</h3>
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">Assign quizzes as homework with a set due date — students complete at their own pace with AI hints available</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
                        <p className="text-xs font-bold text-green-100">Extends learning beyond the classroom with self-paced review</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Insights Report</h3>
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">After a quiz, open the detailed report → View scores per student and per question with highlighted weak areas</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
                        <p className="text-xs font-bold text-green-100">Instantly know which concept needs reteaching</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent flex flex-col gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Improvement Guide</h3>
                    <div className="space-y-4">
                      <div className="text-sm">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1">How to Use:</p>
                        <p className="text-site-text">AI generates a personalized study guide for each student based on the questions they got wrong</p>
                      </div>
                      <div className="bg-site-primary/40 p-3 rounded-xl border border-site-accent/10">
                        <p className="text-site-text uppercase font-bold text-[10px] tracking-widest mb-1 text-green-400">Benefit:</p>
                        <p className="text-xs font-bold text-green-100">Personalizes remediation without extra teacher workload</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {[
          {
                    "step": 1,
                    "title": "Sign Up",
                    "content": "Go to the Quizizz website. Click \"Sign Up Free\" and select \"Teacher\" as your role."
          },
          {
                    "step": 2,
                    "title": "Create Your First Quiz",
                    "content": "Click \"+ Create\" \u2192 Select \"Quiz\" \u2192 Choose \"Create with AI.\" Enter your topic (e.g., \"Photosynthesis \u2013 Grade 8\") or paste a reading passage. Choose question type (Multiple Choice, True/False, Fill-in-the-blank) and click \"Generate.\""
          },
          {
                    "step": 3,
                    "title": "Host or Assign Homework",
                    "content": "Click \"Start Live Quiz\" to play as a class game \u2014 share the join code with students. Or click \"Assign\" to set it as homework with a deadline. Enable \"Adaptive Mode\" in settings for AI-adjusted difficulty."
          },
          {
                    "step": 4,
                    "title": "Analyze Results",
                    "content": "Open the quiz report \u2192 View class accuracy per question and individual student scores. Identify the top 3 questions students struggled with most. Use the AI-generated study guide to assign targeted review to struggling students."
          }
].map((step) => (
            ...
            <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="bg-yellow-400/10 border border-yellow-400/20 rounded-3xl p-10">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-site-text/70">"Run an AI-generated quiz and analyze student performance."</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent space-y-6">
                  ...
                  <p className="text-sm text-site-text">Use Quizizz AI to generate a 10-question quiz on a topic you are currently teaching. Enable Adaptive Mode before launching.</p>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl font-bold">Run It Live</h3>
                  </div>
                  <p className="text-sm text-site-text">Host the quiz as a live game in class or assign it as homework to at least 5 students. Let the AI adapt in real time.</p>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl font-bold">Review the Report</h3>
                  </div>
                  <p className="text-sm text-site-text">Open the post-quiz insights. Identify the 3 questions with the lowest accuracy. Note which students scored below 60%.</p>
                </div>
                <div className="bg-site-bg rounded-3xl p-8 border border-site-accent space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl font-bold">Act on Insights</h3>
                  </div>
                  <p className="text-sm text-site-text">Assign the AI-generated study guide to struggling students. Plan a 5-minute reteach targeting the weakest question.</p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-site-bg p-6 rounded-3xl border border-site-accent relative overflow-hidden group hover:border-pink-500/50 transition-all">
                    ...
                    <p className="text-sm leading-relaxed text-site-text">
                      <span className="font-bold text-site-primary block mb-1">🎮 Engagement Hack:</span>
                      Run a short 5-question Quizizz as a warm-up to activate prior knowledge before each lesson.
                    </p>
                  </div>
                  <div className="bg-site-bg p-6 rounded-3xl border border-site-accent relative overflow-hidden group hover:border-site-primary-500/50 transition-all">
                    ...
                    <p className="text-sm leading-relaxed text-site-text">
                      <span className="font-bold text-site-primary block mb-1">🔄 Re-Quiz Strategy:</span>
                      After reteaching, reassign the same quiz to show students their improvement — a powerful motivator.
                    </p>
                  </div>
                  <div className="bg-site-bg p-6 rounded-3xl border border-site-accent relative overflow-hidden group hover:border-yellow-500/50 transition-all">
                    ...
                    <p className="text-sm leading-relaxed text-site-text">
                      <span className="font-bold text-site-primary block mb-1">📊 Data to Action:</span>
                      Share the class accuracy report with students — seeing the data encourages ownership of their own learning gaps.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <p className="text-center text-site-text/60 text-sm pb-10">
          Next Up: Day 12 – Continue your AI education journey
        </p>
