  ...
  return (
    ...
    >
      <div className="relative h-48 overflow-hidden">
        ...
        />
        <div className="absolute top-4 right-4 bg-site-bg/90 dark:bg-site-primary/90 backdrop-blur px-2 py-1 rounded-lg text-xs font-semibold flex items-center gap-1 shadow-sm">
          <Star className="w-3 h-3 fill-yellow-400 text-yellow-400" />
          <span>{rating}</span>
        </div>
      </div>
      <div className="p-6 flex flex-col flex-grow text-left">
        <h3 className="text-xl font-bold text-site-text dark:text-white mb-2 leading-tight">
          {title}
        </h3>
        <p className="text-sm text-site-text/80 dark:text-slate-400 mb-6 line-clamp-2">
          {description}
        </p>
        <div className="mt-auto flex items-center justify-between">
          <div className="flex items-center gap-2 text-xs text-site-text/80 font-medium">
