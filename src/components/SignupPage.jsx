    ...
    <div className="min-h-screen bg-gradient-to-r from-site-grad-from to-site-grad-to flex items-center justify-center p-6">
      <div className="max-w-[440px] w-full bg-site-bg rounded-sm shadow-sm p-6 sm:p-10 relative">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-site-text mb-3 tracking-tight">Create Your Account</h1>
          <p className="text-site-text/80 font-medium text-sm">Start your AI learning journey today</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-2">
            ...
            <input 
              ...
              className="w-full px-5 py-4 bg-site-bg border border-site-accent rounded-sm focus:outline-none focus:border-brand-primary/30 focus:ring-4 focus:ring-brand-primary/5 transition-all font-medium text-site-text placeholder:text-slate-300"
            />
          </div>
