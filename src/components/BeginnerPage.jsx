...
const SectionHeader = ({ title, subtitle }) => (
  <div className="mb-12">
    <h2 className="text-3xl font-bold text-site-text mb-3 tracking-tight">{title}</h2>
    <p className="text-site-text/80 font-medium">{subtitle}</p>
  </div>
);
...
const ContentCard = ({ children, className = "" }) => (
  <motion.div
    ...
    viewport={{ once: true }}
    className={`bg-site-bg rounded-3xl border border-site-accent p-8 shadow-sm hover:shadow-md transition-shadow ${className}`}
  >
    {children}
  </motion.div>
);
        ...
        {isMobileMenuOpen && (
          <motion.div key="mobile-menu-container" className="fixed inset-0 z-50 lg:hidden">
            <motion.div
              ...
              className="absolute inset-0 bg-site-primary/20 backdrop-blur-sm"
            />
            <motion.div
              initial={{ x: '-100%' }}
              animate={{ x: 0 }}
              ...
              <section key={section.id} id={section.id} className="scroll-mt-32">
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          {[{ icon: Target, text: "What you want" }, { icon: Zap, text: "How you want it" }, { icon: User, text: "Who it's for" }].map((item, i) => (
                            <div key={i} className="flex items-center gap-4 bg-site-bg/10 p-4 rounded-2xl backdrop-blur-sm border border-white/10">
                ...
                {section.type === 'comparison' && (
                  <div className="space-y-12">
                    <p className="text-site-text/80 font-medium text-lg italic border-l-4 border-site-accent pl-6">
                ...
                {section.type === 'formula' && (
                  <div className="space-y-12">
                    ...
                    <ContentCard className="p-10">
                      ...
                      <div className="mt-10 bg-site-bg p-8 rounded-3xl border border-site-accent shadow-inner">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      {[
                        ...
                        <div key={i} className="bg-site-bg p-8 rounded-3xl border border-site-accent shadow-sm flex gap-6 items-start hover:shadow-md transition-shadow">
                          ...
                          <div>
                            <h4 className="font-bold text-site-text mb-2">{tech.t}</h4>
                            <p className="text-site-text/80 text-sm font-medium">{tech.d}</p>
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                {section.type === 'grid' && (
                  <div className="space-y-12">
                    <p className="text-site-text/80 font-medium text-lg leading-relaxed">
                  ...
                  <div className="space-y-10">
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                      {[
                        ...
                        { t: "Privacy", icon: Lock, c: "text-site-primary", bg: "bg-blue-50", d: "Never share sensitive company or personal data." },
                        ...
                        <div key={i} className={`${item.bg} p-10 rounded-[40px] border border-transparent shadow-sm hover:shadow-lg transition-all`}>
                          ...
                          <h4 className="font-bold text-site-text mb-4 text-xl">{item.t}</h4>
