          ...
          <div className="text-center space-y-6 pt-8">
            ...
            <div className="flex flex-wrap justify-center gap-8 pt-4">
              <span className="flex items-center gap-2 text-site-text">
                <Layers size={16} /> Boosts Engagement
              </span>
              <span className="flex items-center gap-2 text-site-text">
                <Clock size={16} /> Saves Time
              </span>
              <span className="flex items-center gap-2 text-site-text">
                <Layers size={16} /> Multilingual
              </span>
            </div>
          </div>
        </div>
          ...
          {activeTab === 'overview' && (
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="bg-site-bg rounded-3xl p-10 border border-site-accent">
                <h2 className="text-3xl text-site-text font-bold mb-6">What is Lumen5?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                  { [
                      { icon: Layers, title: 'Boosts Engagement', desc: 'Converts static lessons into dynamic videos' },
                      { icon: Clock, title: 'Saves Time', desc: 'Creates videos in minutes (vs. hours)' },
                      { icon: Layers, title: 'Supports Accessibility', desc: 'Auto-captions and multilingual options' },
            ...
            <div className="space-y-12 animate-in fade-in duration-500">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    { step: 1, title: 'Paste Text', desc: 'Lesson plans or script'},
                    { step: 2, title: 'AI Generates', desc: 'Scenes and images'},
                    { step: 3, title: 'Customize', desc: 'Edit and add media'},
                    { step: 4, title: 'Export', desc: 'Share or download'}
                  ].map((flow, i) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  { title: 'Student Projects', icon: Layers, desc: 'Have students create videos as assignments. Lumen5 is student-friendly and builds digital literacy.' },
                  { title: 'Analytics', icon: TrendingUp, desc: 'Track engagement via Lumen5\'s social integrations. Monitor views and completion rates.' }
                ].map((tip, i) => (
