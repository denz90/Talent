    ...
    modules: [
      ...
      },
      {
        ...
        days: [
          ...
          { 
            id: 11, 
            title: 'Day 11: Kahoot! AI Challenge', 
            duration: '20 min read', 
            color: 'text-pink-600', 
            bg: 'bg-pink-50/50',
            quizData: [
      ...
      },
      {
        ...
        days: [
            ...
            quizData: [
              ...
              },
              {
                ...
                correctAnswer: 2
                    ...
                    { 
            id: 13, 
            title: 'Day 13: Curipod Challenge', 
            duration: '20 min read', 
            color: 'text-purple-600', 
            bg: 'bg-purple-50/50',
            quizData: [
          ...
          { 
            id: 14, 
            title: 'Day 14: Labster Challenge', 
            duration: '20 min read', 
            ...
            quizData: [
              ...
              },
              {
                ...
                correctAnswer: 3
                    ...
                    { 
            id: 15, 
            title: 'Day 15: TeacherMatic Challenge', 
            duration: '20 min read', 
            color: 'text-purple-600', 
            bg: 'bg-purple-50/50',
            quizData: [
          ...
          { 
            id: 17, 
            title: 'Day 17: Ellie AI Challenge', 
            duration: '20 min read', 
            color: 'text-indigo-600', 
            bg: 'bg-indigo-50/50',
            quizData: [
          ...
          { 
            id: 18, 
            title: 'Day 18: Gradescope Challenge', 
            duration: '20 min read', 
            color: 'text-indigo-600', 
            bg: 'bg-indigo-50/50',
            quizData: [
          ...
          { 
            id: 19, 
            title: 'Day 19: Turnitin AI Feedback Challenge', 
            duration: '20 min read', 
            color: 'text-indigo-600', 
            bg: 'bg-indigo-50/50',
            quizData: [
          ...
          { 
            id: 20, 
            title: 'Day 20: Edthena AI Coach Challenge', 
            duration: '20 min read', 
            color: 'text-indigo-600', 
            bg: 'bg-indigo-50/50',
            quizData: [
          ...
          { 
            id: 21, 
            title: 'Day 21: Loop AI Challenge', 
            duration: '20 min read', 
            color: 'text-indigo-600', 
            bg: 'bg-indigo-50/50',
            quizData: [
